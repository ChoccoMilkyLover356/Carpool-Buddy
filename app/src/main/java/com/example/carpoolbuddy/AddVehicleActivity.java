...
public class AddVehicleActivity extends AppCompatActivity {
    ...
    public void createVehicle(View v) {
        ...
        if(selectedType.equals("Car")) {
            ...
            newVehicle = new Car(rangeInt, ownerString, modelString, capacityInt, vehicleId, basePriceDouble);
        }
        else if(selectedType.equals("Boat")) {
            int capacityInt = Integer.parseInt(capacityField.getText().toString());
            newVehicle = new Boat(speedInt, weightInt, ownerString, modelString, capacityInt, vehicleId, basePriceDouble);
        }
        else if(selectedType.equals("Helicopter")) {
            newVehicle = new Helicopter(altitudeInt, airSpeedInt, ownerString, modelString, 2, vehicleId, basePriceDouble);
        }
        else if(selectedType.equals("Bus")) {
            int capacityInt = Integer.parseInt(capacityField.getText().toString());
            newVehicle = new Bus(sizeInt,ownerString, modelString, capacityInt, vehicleId, basePriceDouble);
        }
